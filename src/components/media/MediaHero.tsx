  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="/lovable-uploads/media_bg.png"
      ...
      <div className="relative z-10 h-full flex flex-col items-center xl:items-start justify-end xl:justify-center pb-4 xl:pb-0 px-[120px] max-md:px-5 text-white">
        <h1 className="leading-[1.2em] xl:leading-[1em] text-center xl:text-left font-normal xl:font-normal uppercase max-md:max-w-full text-[34px] xl:text-[98px] font-proxima xl:mb-2">
          MEDIA: LATEST NEWS,
          <br />
          AND <span className="font-bold italic">INNOVATIONS</span>
        </h1>
        <p className="text-[#D9D9D9] text-[16px] font-medium xl:font-normal xl:text-xl text-center xl:text-left leading-[22px] xl:leading-[34px] mt-[10px] xl:mt-5 max-md:max-w-full lg:w-5/12">
          ...
          <br />
          transport, and discover insights from FUTRAN.
        </p>
        <img
